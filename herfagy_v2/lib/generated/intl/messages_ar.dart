...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(price) => "${price} جنيه";

  static String m4(percent) => "%${percent}";

  static String m5(count) => "غير مكتملة: ${count}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "darkMode": MessageLookupByLibrary.simpleMessage("الوضع الليلى"),
    ...
    "galleryTitle": MessageLookupByLibrary.simpleMessage("معرض الأعمال"),
